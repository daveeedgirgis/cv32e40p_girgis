...
show_usage() {
    ...
    echo ""
    echo "  === Stage 2 Advanced Tests ==="
    echo "  alu_exhaustive_test           - Comprehensive ALU operation coverage"
    echo "  alu_data_pattern_test         - Boundary values and data patterns"
    echo "  alu_mixed_workload_test       - Realistic software simulation"
    echo "  alu_pipeline_hazard_test      - RAW/WAR/WAW hazard analysis"
    echo "  alu_corner_case_test          - Overflow/underflow/edge conditions"
    echo "  alu_performance_test          - IPC measurement and analysis"
    echo "  alu_stress_test               - High-load resource exhaustion"
    echo "  alu_comprehensive_stage2_test - Full Stage 2 verification suite"
    echo ""
    echo "Examples:"
    ...
    echo "  $0 alu_comprehensive_stage2_test      # Run full Stage 2 suite"
    echo "  $0 alu_performance_test UVM_LOW       # Performance analysis"
}
